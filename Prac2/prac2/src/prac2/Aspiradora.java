...
public class Aspiradora extends Agent
{
    ...
    private final ImageIcon high = new ImageIcon("prac2/imagenes/buttercup.png");
    private final ImageIcon medium = new ImageIcon("prac2/imagenes/bubbles.png");
    private final ImageIcon low = new ImageIcon("prac2/imagenes/blossom.png");
    private final ImageIcon dead = new ImageIcon("prac2/imagenes/skull.png");
