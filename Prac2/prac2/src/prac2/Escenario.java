...
public class Escenario extends JFrame {
    ...
    private final ImageIcon dirt = new ImageIcon("prac2/imagenes/leaf.png");
    private final ImageIcon obstacleIcon = new ImageIcon("prac2/imagenes/obstacle.jpg");
    private final ImageIcon stationIcon = new ImageIcon("prac2/imagenes/station.jpg");
    private ImageIcon actualIcon;
    private final BackGroundPanel floor = new BackGroundPanel(new ImageIcon("prac2/imagenes/floor.jpg"));
